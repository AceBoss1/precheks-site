            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm text-paper/80">
                ...
                <li className="flex items-center gap-4 pt-2">
                  {/* WhatsApp */}
                  <a href="https://wa.me/+447918285805" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-paper/70 hover:text-gold transition-colors">
                  ...
                  {/* Facebook */}
                  <a href="https://www.facebook.com/chymdy.achi" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-paper/70 hover:text-gold transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  </a>
                  {/* Instagram */}
                  <a href="https://www.instagram.com/chymdy_kay" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-paper/70 hover:text-gold transition-colors">
                  ...
                  {/* X / Twitter */}
                  <a href="https://x.com/chymdytwoo" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-paper/70 hover:text-gold transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L1.254 2.25H8.08l4.259 5.631 5.905-5.631zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                  </a>
                  {/* LinkedIn */}
                  <a href="https://www.linkedin.com/in/chimdinma-onwuegbu" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-paper/70 hover:text-gold transition-colors">
